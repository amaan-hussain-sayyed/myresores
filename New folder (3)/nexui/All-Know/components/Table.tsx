...
export default function TableContainer({INITIAL_VISIBLE_COLUMNS,columns,Datas,statusOptions}:{INITIAL_VISIBLE_COLUMNS:any,columns:any,Datas:any,statusOptions:any}) {
    ...
    const classNames = React.useMemo(
        () => ({
            ...
            td: [
                ...
                // first
                "group-Datas-[first=true]:first:before:rounded-none",
                "group-Datas-[first=true]:last:before:rounded-none",
                // middle
                "group-Datas-[middle=true]:before:rounded-none",
                // last
                "group-Datas-[last=true]:first:before:rounded-none",
                "group-Datas-[last=true]:last:before:rounded-none",
            ],
        }),
        [],
    );
