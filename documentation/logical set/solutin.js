...
rotateArray(arr, k) {
   ...
   this. reverse1Array(arr, 0, n - 1);
    this.reverse1Array(arr, 0, k - 1);
    this.reverse1Array(arr, k, n - 1);

    return arr;
}
reverse1Array(arr, start, end) {
    while (start < end) {
        let temp = arr[start];
        arr[start] = arr[end];
        arr[end] = temp;
...
let newarr = new Arr()
let data1 = [1, 2, 5, 6, 7, 8, 3, 2, 5]
let data2 = [13, 12, 11, 7, 7, 9, 3, 2, 5]
